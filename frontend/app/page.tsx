...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      {/* Navbar */}
      <nav aria-label="Ana Menü" className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-0 z-20 shadow-sm">
        ...
        {/* Navigation links – UL/LI ile semantik */}
      ...
      {/* Main content */}
      <main id="main-content" className="max-w-6xl mx-auto p-6 lg:p-12 -mt-16" aria-label="Etkinlik Listesi">
